    ...
    return (
        <div className='px-5 w-full'>
            ...
            {postData !== null && postData.map((data)=>{
                ...
                return(
                    <div key={data.id} className="mt-3 p-3 px-4 mb-3 w-8/12 bg-white border border-slate-300 rounded-xl">
                        <div className="flex justify-between px-4 pt-2">
                            
                            <div className="mt-4 flex gap-4 items-center mb-5">
                                <div className="flex items-center space-x-4">                        
                                    <div className="relative me-1 w-10 h-10 overflow-hidden bg-gray-100 rounded-full">
                                        <svg className="absolute w-12 h-12 text-gray-400 -left-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path></svg>
                                    </div>

                                    <div className="font-medium">
                                        <div className='font-semibold'>{data.user_id.username}</div>
                            ...
                            { currentUser?.id === data.user_id.id && (
                                <div className="dropdown dropdown-bottom dropdown-end flex">
                                    <button tabIndex={0} className='items-center ml-2 me-3 mb-3' onMouseOver={() => setPostId(data.id)}>
                        ...
                        <div className="flex flex-col pb-5 ">
                            ...
                            <div className="divider px-4 m-0 mb-3 mt-4"></div>
